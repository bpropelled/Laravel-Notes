# Cheat Sheet
[Laravel Cheat Sheet](https://laravel.gen.tr/cheatsheet/)
...
#### [Configuration](#Configuration)[](http://laravel.com/docs/configuration "Configuration Docs")
```php
...
#### [Routing](#routing)[](http://laravel.com/docs/routing "Routing @ Laravel Docs")
```php
...
#### [App](#app)[](http://laravel.com/docs/helpers#app "App @ Laravel Docs")
```php
App::environment();
// test equal to
...
#### [Log](#log)[](http://laravel.com/docs/helpers#log "Log @ Laravel Docs")
```php
Log::info('info');
...
#### [URLs](#urls)[](http://laravel.com/docs/helpers#urls "URLs @ Laravel Docs")
```php
URL::full();
URL::current();
URL::previous();
...
#### [Events](#events)[](http://laravel.com/docs/events "Events @ Laravel Docs")
```php
...
#### [Database](#db)[](http://laravel.com/docs/queries "Query Builder @ Laravel Docs")
```php
DB::connection('connection_name');
DB::statement('drop table users');
DB::listen(function($sql, $bindings, $time){ code_here; });
DB::transaction(function(){ transaction\_code\_here; });
...
#### [Eloquent](#eloquent)[](http://laravel.com/docs/eloquent "Eloquent @ Laravel Docs")
```php
...
Model::updateOrCreate(array('search\_key' => 'search\_value'), array('key' => 'value'));
...
#### [Schema](#db)[](http://laravel.com/docs/schema "Schema Builder @ Laravel Docs")
```php
...
$table->dropPrimary('table\_column\_primary');
$table->dropUnique('table\_column\_unique');
$table->dropIndex('table\_column\_index');
```       
...
$table->dropForeign('posts\_user\_id_foreign');
```       
...
// Adds created\_at and updated\_at columns
$table->timestamps();
...
$table->rememberToken();
// Adds INTEGER parent\_id and STRING parent\_type
$table->morphs('parent');
->nullable()
->default($value)
->unsigned()
...
#### [Cookies](#cookies)[](http://laravel.com/docs/requests#cookies "Cookies @ Laravel Docs")
```php
Cookie::get('key');
...
#### [Sessions](#sessions)[](http://laravel.com/docs/session "Session @ Laravel Docs")
```php
Session::get('key');
...
#### [Requests](#requests)[](http://laravel.com/docs/requests#request-information "Requests @ Laravel Docs")
```php
...
#### [Responses](#responses)[](http://laravel.com/docs/responses "Responses @ Laravel Docs")
```php
...
#### [Redirects](#redirects)[](http://laravel.com/docs/responses#redirects "Redirects @ Laravel Docs")
```php
...
#### [IoC](#ioc)[](http://laravel.com/docs/ioc "IoC Container @ Laravel Docs")
```php
...
#### [Security](#security)[](http://laravel.com/docs/security "Security @ Laravel Docs")
...
#### [Queues](#queues)[](http://laravel.com/docs/queues "Queues @ Laravel Docs")
```
...
#### [Views](#views)[](http://laravel.com/docs/responses#views "Views @ Laravel Docs")
```php
...
#### [Blade Templates](#blade)[](http://laravel.com/docs/blade "Blade Templating @ Laravel Docs")
```php
@extends('layout.name')
// Begin a section
@section('name')
...
#### [Forms](#forms)[](http://laravel.com/docs/html "Forms & HTML @ Laravel Docs")
```php
...
#### [Strings](#str)[](http://laravel.com/docs/helpers#strings "Strings CLI @ Laravel Docs")
```php
...
#### [Localization](#localization)[](http://laravel.com/docs/localization "Localization @ Laravel Docs")
```php
App::setLocale('en');
...
#### [Files](#files)[](http://laravel.com/api/class-Illuminate.Filesystem.Filesystem.html "Filesystem @ Laravel Docs")
```php
File::exists('path');
File::get('path');
File::getRemote('path');
...
#### [Helpers](#helpers)[](http://laravel.com/docs/helpers "Helpers @ Laravel Docs")
...
link\_to\_asset('img/foo.jpg', $title, $attributes, $secure);
link\_to\_route('route.name', $title, $parameters, $attributes);
link\_to\_action('FooController@method', $title, $params, $attrs);
// HTML Link
...
#### [Unit testing](#unittest)[](http://laravel.com/docs/unittest "Unit testing @ Laravel Docs")
